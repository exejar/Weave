 ...
 */
public class ChatReceivedEvent(public val message: ITextComponent) : CancellableEvent()
...
public sealed class RenderLivingEvent(
    public val renderer: RenderLivingBase<EntityLivingBase>,
     ...
     */
    public class Pre(
        renderer: RenderLivingBase<EntityLivingBase>,
